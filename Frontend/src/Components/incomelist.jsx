...
const IncomeList = () => {
  ...
  const fetchIncomeData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`miraculous-beauty-production.up.railway.app/api/userdata/${user._id}/income`);
  ...
  const handleDelete = async (incomeId) => {
    if (window.confirm("Are you sure you want to delete this income entry?")) {
      try {
        await axios.delete(`miraculous-beauty-production.up.railway.app/api/userdata/${user._id}/income/${incomeId}`);
